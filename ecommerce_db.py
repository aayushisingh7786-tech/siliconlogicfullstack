...
# Check if the database file exists, and delete it to start fresh for demonstration purposes
# If you want to persist data across runs, remove this block
...
def insert_dummy_data(cursor, conn):
    ...
    if cursor.fetchone()[0] > 0:
        print("ℹ️ Dummy data already exists. Skipping insertion.")
        return
...
if __name__ == "__main__":
    ...
    # Corrected: simply call the method without arguments
    conn.close() 
