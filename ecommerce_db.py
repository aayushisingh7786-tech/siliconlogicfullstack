...
def insert_dummy_data(): 
    cursor.execute("INSERT OR IGNORE INTO categories (name) VALUES ('Electronics')")  cursor.execute("INSERT OR IGNORE INTO categories (name) VALUES ('Books')") 

     cursor.execute("INSERT OR IGNORE INTO users (name, email) VALUES ('Rahul', 
 'rahul@example.com')")  cursor.execute("INSERT OR IGNORE INTO users (name, email) VALUES ('Priya',  'priya@example.com')") 

 cursor.execute("INSERT INTO products (name, price, category_id) VALUES ('Laptop', 45000.00, 1)")  cursor.execute("INSERT INTO products (name, price, category_id) VALUES ('Python Guide', 500.00, 
 2)") 

cursor.execute("INSERT INTO orders (user_id, product_id, order_date) VALUES (1, 1, 
 '2025-10-25')") 
 conn.commit()  print("✅ Dummy data inserted.") 
...
if __name__ == "__main__": 
 create_tables()  insert_dummy_data()  show_all_orders() 
 # Close connection  
 conn.close() 
